  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center bg-white rounded-2xl shadow-lg border border-slate-100">
      ...
      {actionLabel && onAction && (
        <button
          onClick={onAction}
          className="min-h-[48px] min-w-[48px] px-6 py-2 bg-slate-900 text-white font-bold rounded-2xl hover:bg-slate-800 transition-transform active:scale-95 shadow-md flex items-center justify-center"
        >
          {actionLabel}
        </button>
      )}
