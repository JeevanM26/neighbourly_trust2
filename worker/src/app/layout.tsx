...
export const metadata: Metadata = {
  title: 'HeroHand — One App. All Workers.',
  description: 'Manage your service bookings, skills, and earnings with HeroHand. Accept jobs, track income, and grow your business.',
  authors: [{ name: 'HeroHand' }],
};
